...
$to = "xela07ax@gmail.com"; //получатель уведомлений
...
$sms["id"] = "";
$sms["key"] = "ff7eac33-3ab2-7bb4-4d1a-28f0bcf21609";
$sms["log"] = "";
$sms["pss"] = "";
$sms["frm"] = "injeneer"; // добавьте новую подпись в смс-шлюзе и дождитесь апрува
$sms["num"] = "79166903225"; // ваш номер в формате без + (79218886622)
